...
namespace QuanLyNhaHang
{
    public class ketnoics
    {
        ...
        private void layknoi()
        {
            ...
            con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C: \Users\Duc khong gay\Desktop\Đồ án chuyên ngành\Do_An_Chuyen_Nganh\QuanLyNhaHang\QuanLyNhaHang\QuanLyNhaHang\App_Data\Database1.mdf;Integrated Security=True");
            con.Open();//mở kết nối
